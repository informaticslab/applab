...
define ('CMTX_NOT_CONFIRMED', 'Das Abo wurde noch nicht bestätigt.');
define ('CMTX_ACTIVATED', 'Das Abo ist jetzt aktiviert.');
define ('CMTX_ALREADY_ACTIVATED', 'Das Abo wurde bereits aktiviert.');
