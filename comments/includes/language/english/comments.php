...
define ('CMTX_NO_COMMENTS', 'Be the first to add a comment.');
...
define ('CMTX_TITLE_SORT_1', 'Sort by the newest first.');
define ('CMTX_TITLE_SORT_2', 'Sort by the oldest first.');
define ('CMTX_TITLE_SORT_3', 'Sort by the most helpful first.');
define ('CMTX_TITLE_SORT_4', 'Sort by the most useless first.');
define ('CMTX_TITLE_SORT_5', 'Sort by the most positive first.');
define ('CMTX_TITLE_SORT_6', 'Sort by the most critical first.');
...
define ('CMTX_FLAG_REASON', 'Please enter a short reason for the report');
define ('CMTX_FLAG_NO_REASON', 'You must enter a reason for the report!');
define ('CMTX_FLAG_NO_COMMENT', 'This comment no longer exists!');
define ('CMTX_FLAG_OWN_COMMENT', 'You cannot report your own comment!');
define ('CMTX_FLAG_BAD_REPORT', 'You have previously submitted a bad report!');
...
define ('CMTX_INFO_OF', 'of');
define ('CMTX_INFO_COMMENT', 'comment');
define ('CMTX_INFO_COMMENTS', 'comments');
